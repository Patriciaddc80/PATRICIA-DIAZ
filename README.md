...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
 <div style="border: 1px sólido #ddd; relleno: 20px;"> <h3>Administrador de productos</h3> <p>Aplicación creada con HTML, CSS, Tailwind y JS, gestiona de manera fácil y sencilla los artículos de una tienda. </p> <!-- Imagen principal --> <a href="https://productmanagerpat.vercel.app/" target="_blank"> <img src="https://github.com/user-attachments/assets/3263d12f-497b-4780-b0fe-e9fd24c3d83c" alt="Administrador de productos" style="width: 50%; radio-borde: 8px;"> </a> </div>
...
<table>
  <tr>
    <th>Desarrollo de Aplicaciones con Tecnología Web (FULLSTACK)</th>
    <th>Frontend Developer con Vue.js</th>
    <th>Máster en SQL Server desde Cero a Nivel Profesional</th>
  </tr>
  <tr>
    <td align="center">
      <img src="https://github.com/Patriciaddc80/PATRICIA-DIAZ/assets/98458936/a3ddacd8-09fd-408b-9e6c-2f8aeccb16ff" alt="Desarrollo de aplicaciones con tecnología web" width="200">
    </td>
    <td align="center">
      <img src="https://github.com/Patriciaddc80/PATRICIA-DIAZ/assets/98458936/d2c604bf-9218-4281-b741-090a6001e3cd" alt="Frontend Developer con Vue.js" width="200">
    </td>
    <td align="center">
      <img src="https://github.com/user-attachments/assets/4c612b54-f507-4297-9c72-52e8165844b5" alt="Máster en SQL Server desde Cero a Nivel Profesional" width="200">
    </td>
  </tr>
</table>
